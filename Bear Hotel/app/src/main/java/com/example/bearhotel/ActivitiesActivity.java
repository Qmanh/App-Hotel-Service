...
public class ActivitiesActivity extends Activity {
    ...
    TextView descText1, descText2, descText3, textUsername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(ActivitiesActivity.this, ManagerActivityNav.class);
        ...
        btn2 = (Button) findViewById(R.id.btnRepair);
        btn3 = (Button) findViewById(R.id.btnClean);
