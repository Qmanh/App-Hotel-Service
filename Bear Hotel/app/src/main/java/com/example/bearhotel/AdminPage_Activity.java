...
public class AdminPage_Activity extends AppCompatActivity {
    ...
    private DatabaseReference dbRefRequest;
    ...
    EditText name, email, firstName, lastName, phone;
    RadioButton rdbTable1, rdbTable2, rdbTable3, rdbTable4, rdbTable5, rdbTable6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fabHome = (FloatingActionButton) findViewById(R.id.floatingActionButtonPay);
        fabHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AdminPage_Activity.this, MainActivity.class);
       ...
       /* dbRefRequest = mFirebaseDatabase.getReference("users");
        ...
        dbRefOrders = mFirebaseDatabase.getReference("order");
        dbRefRoomReview = mFirebaseDatabase.getReference("room_review");
        dbRefRequest = mFirebaseDatabase.getReference("requests");
        mAuth = FirebaseAuth.getInstance();
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        ...
        rdbTable6 = (RadioButton) findViewById(R.id.rdbTable6);
                    ...
                    next.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            switch (selectedTable)
                            {
                                                ...
                                                for (DataSnapshot postSnapshot1: postSnapshot.getChildren())
                                                {
                                                    resultText.append(
                                                            "Date: " + postSnapshot1.child("date").getValue().toString()
                                                                    ...
                                                                    + '\n' + "Price: " + postSnapshot1.child("price").getValue().toString()
                                                                    + '\n' + "Quantity: " + postSnapshot1.child("quantity").getValue().toString()
                                                                    + '\n' + "Room: " + postSnapshot1.child("room").getValue().toString()
                                ...
                                case "Requests":
                                    dbRefRequest.addValueEventListener(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                            resultText.setText("");
                                            resultText.append("List of orders in database: " + '\n' + '\n');
                                            for (DataSnapshot postSnapshot: dataSnapshot.getChildren())
                                            {
                                                for (DataSnapshot postSnapshot1: postSnapshot.getChildren())
                                                {
                                                    resultText.append(
                                                            "Date: " + postSnapshot1.child("date").getValue().toString()
                                                                    + '\n' + "Request: " + postSnapshot1.child("request").getValue().toString()
                                                                    + '\n' + "Room: " + postSnapshot1.child("room").getValue().toString()
                                                                    + '\n' + "Phone: " + postSnapshot1.child("phone").getValue().toString()
                                                                    + '\n' + "UserID: " + postSnapshot.getKey().toString()
                                                                    + '\n' + '\n');
                                                }
                                            }
                        ...
                        public void onClick(View view) {
                                    ...
                                    try
                                    {
                                        ...
                                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren())
                                        {
                                            if (postSnapshot.child("email").getValue().toString().equals(email.getText().toString()))
                                            {
                                                ...
                                                phone.setText(postSnapshot.child("phone").getValue().toString());
                            ...
                            save.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    dbRefUsers.child(key1).child("phone").setValue(phone.getText().toString());
